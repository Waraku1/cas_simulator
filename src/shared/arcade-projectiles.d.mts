...
export function createArcadeProjectile(id: number, ownerSlot: 1 | 2, weaponId: WeaponId, nowMs: number, localPose: AircraftPose, peerPose: GamePosition, maximumDistance: number): ArcadeProjectile;
